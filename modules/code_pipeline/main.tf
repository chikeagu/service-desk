...
resource "aws_codebuild_project" "service_desk_build" {
  name          = "service-desk-codebuild"
  build_timeout = "10"
  ...
  stage {
    ...
    action {
      ...
      configuration {
        ...
        Branch     = "master"
        OAuthToken = "87fc20442b4d19ba0b055c4e291a7ce9b6882b6f"
      }
    }
  }
